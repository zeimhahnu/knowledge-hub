...
const EVENT_ALIASES: Record<CanonicalEventId, readonly string[]> = {
  ...
  "primary-offering": ["primary offering", "follow-on offering", "new share issue"],
  "secondary-offering": ["secondary offering", "block sale", "block trade"],
  "private-placement": ["private placement"],
  "forward-sale-agreement": ["forward sale agreement", "forward sale"],
  "return-of-capital": ["return of capital", "capital return"],
  "share-buyback": ["share buyback", "share buy-back", "share repurchase"],
