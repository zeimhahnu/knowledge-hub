...
export type FranklinEtfCatalog = { schema_version: "2.0"; snapshot_id: string; source_url: string; source_urls?: string[]; retrieved_at: string; source_as_of: string | null; scope: string; records: FranklinCatalogRecord[]; counts?: { [key: string]: unknown }; limitations?: string[] };
